...
 * Ensures immutable updates to avoid race conditions.
 */
...
        safeSend(ws, { type: 'loginSuccess', username: username });
...
        // Robust existence check and state check
...
        }
        
        // Check if caller is already busy (in call or ringing another person)
...
        // Mark both as In Call immutably
...
          // Treat logout like a close event for cleanup
          ws.close(1000, "Client initiated logout");
        }
        break;
      }
...
    
    // Explicitly nullify the ws reference to help GC
    userData.ws = null; 
